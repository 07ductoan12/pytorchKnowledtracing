...
class DKVMNHeadGroup(nn.Module):
    def __init__(self, memory_size, memory_state_dim, is_write) -> None:
        """ "
        Parameters
            memory_size:        scalar
        ...
        if self.is_write:
            ...
            nn.init.kaiming_uniform_(self.add.weight)
    ...
    def addressing(self, control_input, memory):
        ...
        correlation_weight = nn.functional.softmax(similarity_score, dim=1)
    ...
    def write(self, control_input, memory, write_weight=None):
        ...
        add_reshape = add_signal.view(-1, self.memory_size, 1)
...
class DKVMN(nn.Module):
    def __init__(
        self, memory_size, memory_key_state_dim, memory_value_state_dim, init_memory_key
    ) -> None:
        """
