...
from pytorchKT.contanst import *


class UserSepDataset(Dataset):
    def __init__(self, name, sample_infos, dataset_name="ASSITments2009") -> None:
        super().__init__()
        self._name = name
    ...
    def __repr__(self) -> str:
        return f"{self._name}: # of sample: {len(self._sample_infos)}"
